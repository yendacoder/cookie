...
mixin _$DiscuitImage {
 ...
 String get id; String get format; String get mimetype; int get width; int get height; int get size; String? get averageColor; String get url; List<ImageCopy> get copies; String? get altText;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,format,mimetype,width,height,size,averageColor,url,const DeepCollectionEquality().hash(copies),altText);

@override
String toString() {
  return 'DiscuitImage(id: $id, format: $format, mimetype: $mimetype, width: $width, height: $height, size: $size, averageColor: $averageColor, url: $url, copies: $copies, altText: $altText)';
}
...
@useResult
$Res call({
 String id, String format, String mimetype, int width, int height, int size, String? averageColor, String url, List<ImageCopy> copies, String? altText
});
...
/// Create a copy of DiscuitImage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? format = null,Object? mimetype = null,Object? width = null,Object? height = null,Object? size = null,Object? averageColor = freezed,Object? url = null,Object? copies = null,Object? altText = freezed,}) {
...
as List<ImageCopy>,altText: freezed == altText ? _self.altText : altText // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String format,  String mimetype,  int width,  int height,  int size,  String? averageColor,  String url,  List<ImageCopy> copies,  String? altText)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiscuitImage() when $default != null:
return $default(_that.id,_that.format,_that.mimetype,_that.width,_that.height,_that.size,_that.averageColor,_that.url,_that.copies,_that.altText);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String format,  String mimetype,  int width,  int height,  int size,  String? averageColor,  String url,  List<ImageCopy> copies,  String? altText)  $default,) {final _that = this;
switch (_that) {
case _DiscuitImage():
return $default(_that.id,_that.format,_that.mimetype,_that.width,_that.height,_that.size,_that.averageColor,_that.url,_that.copies,_that.altText);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String format,  String mimetype,  int width,  int height,  int size,  String? averageColor,  String url,  List<ImageCopy> copies,  String? altText)?  $default,) {final _that = this;
switch (_that) {
case _DiscuitImage() when $default != null:
return $default(_that.id,_that.format,_that.mimetype,_that.width,_that.height,_that.size,_that.averageColor,_that.url,_that.copies,_that.altText);case _:
  return null;
...
class _DiscuitImage implements DiscuitImage {
  const _DiscuitImage({required this.id, required this.format, required this.mimetype, required this.width, required this.height, required this.size, this.averageColor, required this.url, final  List<ImageCopy> copies = const [], this.altText}): _copies = copies;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,format,mimetype,width,height,size,averageColor,url,const DeepCollectionEquality().hash(_copies),altText);
...
/// Create a copy of DiscuitImage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? format = null,Object? mimetype = null,Object? width = null,Object? height = null,Object? size = null,Object? averageColor = freezed,Object? url = null,Object? copies = null,Object? altText = freezed,}) {
