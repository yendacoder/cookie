...
as String,communityProPic: null == communityProPic ? _self.communityProPic : communityProPic // ignore: cast_nullable_to_non_nullable
as DiscuitImage,communityBannerImage: null == communityBannerImage ? _self.communityBannerImage : communityBannerImage // ignore: cast_nullable_to_non_nullable
...
class _Post implements Post {
  const _Post({required this.id, required this.type, required this.publicId, required this.userId, required this.username, this.userGhostId, required this.userGroup, required this.userDeleted, required this.isPinned, required this.isPinnedSite, required this.communityId, required this.communityName, required this.communityProPic, required this.communityBannerImage, required this.title, this.body, this.image, final  List<DiscuitImage> images = const [], this.link, required this.locked, this.lockedBy, this.lockedByGroup, this.lockedAt, required this.upvotes, required this.downvotes, required this.hotness, required this.createdAt, this.editedAt, required this.lastActivityAt, required this.deleted, this.deletedAt, this.deletedBy, this.deletedAs, required this.deletedContent, this.deletedContentAs, required this.noComments, this.userVoted, this.userVotedUp, required this.isAuthorMuted, required this.isCommunityMuted, this.community, this.author}): _images = images;
