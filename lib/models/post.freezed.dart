...
@useResult
$Res call({
 String id, String type, String publicId, String userId, String username, String? userGhostId, String userGroup, bool userDeleted, bool isPinned, bool isPinnedSite, String communityId, String communityName, DiscuitImage? communityProPic, DiscuitImage? communityBannerImage, String title, String? body, DiscuitImage? image, List<DiscuitImage> images, PostLink? link, bool locked, String? lockedBy, String? lockedByGroup, DateTime? lockedAt, int upvotes, int downvotes, int hotness, DateTime createdAt, DateTime? editedAt, DateTime lastActivityAt, DateTime? lastVisitAt, bool deleted, DateTime? deletedAt, String? deletedBy, String? deletedAs, bool deletedContent, String? deletedContentAs, int noComments, bool? userVoted, bool? userVotedUp, bool isAuthorMuted, bool isCommunityMuted, Community? community, User? author, List<Comment>? comments, int? newComments, String? commentsNext
});
...
as List<Comment>?,newComments: freezed == newComments ? _self.newComments : newComments // ignore: cast_nullable_to_non_nullable
as int?,commentsNext: freezed == commentsNext ? _self.commentsNext : commentsNext // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of Post
...
class _Post implements Post {
  const _Post({required this.id, required this.type, required this.publicId, required this.userId, required this.username, this.userGhostId, required this.userGroup, required this.userDeleted, required this.isPinned, required this.isPinnedSite, required this.communityId, required this.communityName, this.communityProPic, this.communityBannerImage, required this.title, this.body, this.image, final  List<DiscuitImage> images = const [], this.link, required this.locked, this.lockedBy, this.lockedByGroup, this.lockedAt, required this.upvotes, required this.downvotes, required this.hotness, required this.createdAt, this.editedAt, required this.lastActivityAt, this.lastVisitAt, required this.deleted, this.deletedAt, this.deletedBy, this.deletedAs, required this.deletedContent, this.deletedContentAs, required this.noComments, this.userVoted, this.userVotedUp, required this.isAuthorMuted, required this.isCommunityMuted, this.community, this.author, final  List<Comment>? comments, this.newComments, this.commentsNext}): _images = images,_comments = comments;
...
@override final  int? newComments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,type,publicId,userId,username,userGhostId,userGroup,userDeleted,isPinned,isPinnedSite,communityId,communityName,communityProPic,communityBannerImage,title,body,image,const DeepCollectionEquality().hash(_images),link,locked,lockedBy,lockedByGroup,lockedAt,upvotes,downvotes,hotness,createdAt,editedAt,lastActivityAt,lastVisitAt,deleted,deletedAt,deletedBy,deletedAs,deletedContent,deletedContentAs,noComments,userVoted,userVotedUp,isAuthorMuted,isCommunityMuted,community,author,const DeepCollectionEquality().hash(_comments),newComments,commentsNext]);
